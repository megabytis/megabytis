...
<p align="center">
  <b>Backend Developer • Full-Stack Engineer • Always Building</b>
</p>

<div align="center">
  <img src="YOUR_GIF_HERE.gif" width="100%" style="border-radius: 12px;">
</div>
...
- Full-stack dev focused on **Node.js, Express, MongoDB**
- Currently mastering **backend architecture + scalable APIs**
- Love building **real, production-ready products**
- Obsessed with **clean structure, auth systems, real-world deployments**
...
### 🛒 **ShopNexus – Full-Stack eCommerce**
Your biggest flex. Production-ready.
- JWT Auth, cart system, checkout, categories, seed script  
...
- Role-based auth, CRUD posts, comments, categories  
...
### 🤝 **DevTinder WebApp – Developer Matchmaking**
- Find developers, chat, matchmaking system  
